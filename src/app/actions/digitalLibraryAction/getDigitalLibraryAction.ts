...
export async function getDigitalLibraryAction() {
  ...
  try {
    const response = await axios.post(
      `${urls.baseurl}/Academic/GetDigiLibraryStudent`,
      requestBody,
      {
        headers: {
    ...
    return {
      message: "Digital Library data fetched successfully",
      status: "success",
    ...
    return {
      message: "Digital Library data failed.",
      status: "error",
    };
  }
}
