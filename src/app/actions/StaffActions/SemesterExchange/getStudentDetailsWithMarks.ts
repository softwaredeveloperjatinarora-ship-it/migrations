...
export async function getStudentDetailsWithMarks(registrationNo: string) {
  ...
  try {
    const response = await axios.get(
      `${urls.basewebapiurl}/SemesterExchangeStudentBridge/GetStudentResultWithGrades`,
      {
        params: { regdno: registrationNo },
