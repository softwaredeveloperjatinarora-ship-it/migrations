...
export interface MetricStageCheckListParams {
  MetricID: number;
  StageType: string;
  IsRequired?: boolean | null;
}

export async function getMetricStagesCheckList(params: MetricStageCheckListParams) {
  ...
  try {
    const response = await axios.post(
      `${urls.basewebapiurl}/Planning/GetOBPMetricStagesCheckList`,
      params,
