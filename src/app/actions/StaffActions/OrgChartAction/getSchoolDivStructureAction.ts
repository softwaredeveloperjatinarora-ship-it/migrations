...
export async function getSchoolDivStructure(wingId: string) {
  ...
  try {
    const response = await axios.post(
      `${urls.basewebapiurl}/OBPStructureBridge/GetSchoolDivStructure?WingId=${wingId}`,
      {},
    ...
    console.error('[Schools] error:', msg);
