...
export async function getStudentDefaulterStatusAction() {
    ...
    let requestBody = {
      ...
      debugger
      try {
        const response = await axios.post(`${urls.baseurl}/Examination/GetStudentDefaulterStatus`,         
        ...
        // console.log("api respionse of marks: ",response);
