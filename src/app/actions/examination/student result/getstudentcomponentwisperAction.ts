...
export async function getStudentComponentWisePercentageAction() {
    ...
    let requestBody = {
      ...
      debugger
      try {
        const response = await axios.post(`${urls.baseurl}/Examination/GetStudentComponentWisePercentage`,         
            requestBody,
            {
                headers: {
