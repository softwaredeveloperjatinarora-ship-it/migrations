...
export async function getStudentObjectiveMarkDetailAction(Data: string) {
    ...
    let requestBody = {
      ...
      debugger
      try {
        const response = await axios.post(`${urls.baseurl}/Examination/GetStudentOMRSheetDetails`,         
